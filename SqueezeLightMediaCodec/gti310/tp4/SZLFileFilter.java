 ...
 */
public class SZLFileFilter extends FileFilter {
	/* unique file extension allowed */
	private static final String EXTENSION = "szl"; //changement de l'extension par bmp
	...
	public String getDescription() {
		...
		return "Sun Raster File (*.szl)";  //changement par .bmp
	}
