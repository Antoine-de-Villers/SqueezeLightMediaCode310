 ...
 */
public class PPMFileFilter extends FileFilter {
	/* unique file extension allowed */
	private static final String EXTENSION = "ppm"; //changement de l'extension par bmp
	...
	public String getDescription() {
		...
		return "Sun Raster File (*.ppm)";  //changement par .bmp
	}
